...
a persistence unit "school-managementPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "school-management/pom.xml":
...
artifacts ("school-management-ejb.jar" and "school-management-web.war") are already built. You can build
